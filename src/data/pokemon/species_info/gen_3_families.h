...
const struct SpeciesInfo gSpeciesInfoGen3[] =
{
    ...
    [SPECIES_BEAUTIFLY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SWARM, ABILITY_LEVITATE, ABILITY_RIVALRY },
    ...
    [SPECIES_DUSTOX] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SHIELD_DUST, ABILITY_LEVITATE, ABILITY_COMPOUND_EYES },
        .bodyColor = BODY_COLOR_GREEN,
...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    #if P_UPDATED_ABILITIES == GEN_CUSTOM
        .abilities = { ABILITY_ELECTRIC_SURGE, ABILITY_SWARM, ABILITY_PRANKSTER },
    #else
    ...
    [SPECIES_ILLUMISE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG, EGG_GROUP_HUMAN_LIKE),
    #if P_UPDATED_ABILITIES == GEN_CUSTOM
        .abilities = { ABILITY_MISTY_SURGE, ABILITY_TINTED_LENS, ABILITY_PRANKSTER },
