...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_DOUBLE_SLAP] =
    {
        ...
        .power = B_UPDATED_MOVE_DATA == GEN_CUSTOM ? 18 : 15,
        .type = TYPE_NORMAL,
    ...
    [MOVE_COMET_PUNCH] =
    {
        ...
        .type = TYPE_NORMAL,
        .accuracy = B_UPDATED_MOVE_DATA == GEN_CUSTOM ? 100 : 85,
        .pp = B_UPDATED_MOVE_DATA == GEN_CUSTOM ? 20 : 15,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .makesContact = TRUE,
    ...
    [MOVE_CUT] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = 50,
        .type = B_UPDATED_MOVE_TYPES == GEN_CUSTOM ? TYPE_STEEL : TYPE_NORMAL,
        .accuracy = 95,
        .pp = B_UPDATED_MOVE_DATA == GEN_CUSTOM ? 25 : 30,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .makesContact = TRUE,
    ...
    [MOVE_POISON_STING] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "etc., that may poison."),
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA == GEN_CUSTOM ? 20 : 15,
        .type = TYPE_POISON,
        .accuracy = 100,
        .pp = 35,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_SUBMISSION] =
    {
        ...
        .power = 80,
        .type = TYPE_FIGHTING,
        .accuracy = B_UPDATED_MOVE_DATA == GEN_CUSTOM ? 95 : 80,
    ...
    [MOVE_SCREECH] =
    {
        ...
        .type = TYPE_NORMAL,
        .accuracy = B_UPDATED_MOVE_DATA == GEN_CUSTOM ? 100 : 85,
        .pp = B_UPDATED_MOVE_DATA == GEN_CUSTOM ? 30 : 40,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_STATUS,
        .zMove = { .effect = Z_EFFECT_ATK_UP_1 },
    ...
    [MOVE_EGG_BOMB] =
    {
        ...
        .power = 100,
        .type = TYPE_NORMAL,
        .accuracy = B_UPDATED_MOVE_DATA == GEN_CUSTOM ? 90 : 75,
        .pp = 10,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
    ...
    [MOVE_SMOG] =
    {
        ...
        .power = B_UPDATED_MOVE_DATA >= GEN_6 ? 30 : 20,
        .type = TYPE_POISON,
        .accuracy = B_UPDATED_MOVE_DATA == GEN_CUSTOM ? 95 : 70,
        .pp = 20,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_SPECIAL,
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_POISON,
            .chance = B_UPDATED_MOVE_DATA == GEN_CUSTOM ? 50 : 40,
        }),
        .contestEffect = CONTEST_EFFECT_BADLY_STARTLE_PREV_MONS,
        .contestCategory = CONTEST_CATEGORY_TOUGH,
    ...
    [MOVE_CONSTRICT] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "May lower Speed."),
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA == GEN_CUSTOM ? 30 : 10,
        .type = TYPE_NORMAL,
        .accuracy = 100,
        .pp = 35,
        .target = MOVE_TARGET_SELECTED,
        ...
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_SPD_MINUS_1,
            .chance = B_UPDATED_MOVE_DATA == GEN_CUSTOM ? 50 : 10,
        }),
        .contestEffect = CONTEST_EFFECT_STARTLE_PREV_MON,
        .contestCategory = CONTEST_CATEGORY_TOUGH,
        .contestComboStarterId = 0,
    ...
    [MOVE_SKY_ATTACK] =
    {
        ...
        .effect = EFFECT_TWO_TURNS_ATTACK,
        .power = B_UPDATED_MOVE_DATA == GEN_CUSTOM ? 160 : 140,
        .type = TYPE_FLYING,
    ...
    [MOVE_FURY_SWIPES] =
    {
        ...
        .power = 18,
        .type = TYPE_NORMAL,
        .accuracy = B_UPDATED_MOVE_DATA == GEN_CUSTOM ? 100 : 80,
        .pp = B_UPDATED_MOVE_DATA == GEN_CUSTOM ? 20 : 15,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .makesContact = TRUE,
        .slicingMove = B_UPDATED_MOVE_FLAGS == GEN_CUSTOM,
        .contestEffect = CONTEST_EFFECT_STARTLE_MON_WITH_JUDGES_ATTENTION,
        .contestCategory = CONTEST_CATEGORY_TOUGH,
        .contestComboStarterId = 0,
    ...
    [MOVE_BATON_PASS] =
    {
        ...
        .type = TYPE_NORMAL,
        .accuracy = 0,
        .pp = B_UPDATED_MOVE_DATA == GEN_CUSTOM ? 10 : 40,
        .target = MOVE_TARGET_USER,
        .priority = 0,
        .category = DAMAGE_CATEGORY_STATUS,
        .zMove = { .effect = Z_EFFECT_RESET_STATS },
    ...
    [MOVE_RAPID_SPIN] =
    {
        ...
        .type = TYPE_NORMAL,
        .accuracy = 100,
        .pp = B_UPDATED_MOVE_DATA == GEN_CUSTOM ? 20 : 40,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .makesContact = TRUE,
    ...
    [MOVE_METAL_CLAW] =
    {
        ...
        .type = TYPE_STEEL,
        .accuracy = 95,
        .pp = B_UPDATED_MOVE_DATA == GEN_CUSTOM ? 30 : 35,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .makesContact = TRUE,
    ...
    [MOVE_ROCK_SMASH] =
    {
        ...
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_DEF_MINUS_1,
            .chance = B_UPDATED_MOVE_DATA == GEN_CUSTOM ? 100 : 50,
        }),
    ...
    [MOVE_FOCUS_PUNCH] =
    {
        ...
        .type = TYPE_FIGHTING,
        .accuracy = 100,
        .pp = B_UPDATED_MOVE_DATA == GEN_CUSTOM ? 10 : 20,
        .target = MOVE_TARGET_SELECTED,
        .priority = -3,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .makesContact = TRUE,
    ...
    [MOVE_SECRET_POWER] =
    {
        ...
        .additionalEffects = ADDITIONAL_EFFECTS({
            ...
            .chance = B_UPDATED_MOVE_DATA == GEN_CUSTOM ? 100 : 30,
        }),
        .contestEffect = CONTEST_EFFECT_BETTER_WITH_GOOD_CONDITION,
        .contestCategory = CONTEST_CATEGORY_SMART,
        .contestComboStarterId = 0,
    ...
    [MOVE_BLAZE_KICK] =
    {
        ...
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_BURN,
            .chance = B_UPDATED_MOVE_DATA == GEN_CUSTOM ? 20 : 10,
        }),
        .contestEffect = CONTEST_EFFECT_HIGHLY_APPEALING,
        .contestCategory = CONTEST_CATEGORY_BEAUTY,
        .contestComboStarterId = 0,
    ...
    [MOVE_NEEDLE_ARM] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "May cause flinching."),
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA == GEN_CUSTOM ? 70 : 60,
        .type = TYPE_GRASS,
        .accuracy = 100,
        .pp = 15,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_ASTONISH] =
    {
        ...
        .type = TYPE_GHOST,
        .accuracy = 100,
        .pp = B_UPDATED_MOVE_DATA == GEN_CUSTOM ? 30 : 15,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .makesContact = TRUE,
    ...
    [MOVE_GRASS_WHISTLE] =
    {
        ...
        .power = 0,
        .type = TYPE_GRASS,
        .accuracy = B_UPDATED_MOVE_DATA == GEN_CUSTOM ? 80 : 55,
        .pp = 15,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_STATUS,
    ...
    [MOVE_ICICLE_SPEAR] =
    {
        ...
        .type = TYPE_ICE,
        .accuracy = B_UPDATED_MOVE_DATA == GEN_CUSTOM ? 95 : 100,
        .pp = B_UPDATED_MOVE_DATA == GEN_CUSTOM ? 20 : 30,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
    ...
    [MOVE_COVET] =
    {
        ...
        .type = B_UPDATED_MOVE_TYPES == GEN_CUSTOM ? TYPE_FAIRY : TYPE_NORMAL,
        .accuracy = 100,
    ...
    [MOVE_PSYCHO_BOOST] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "but sharply lowers Sp. Atk."),
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA == GEN_CUSTOM ? 130 : 140,
        .type = TYPE_PSYCHIC,
        .accuracy = 90,
        .pp = 5,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_MIRACLE_EYE] =
    {
        ...
        .type = TYPE_PSYCHIC,
        .accuracy = 0,
        .pp = B_UPDATED_MOVE_DATA == GEN_CUSTOM ? 15 : 40,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_STATUS,
        .zMove = { .effect = Z_EFFECT_SPATK_UP_1 },
    ...
    [MOVE_HEALING_WISH] =
    {
        ...
        .type = TYPE_PSYCHIC,
        .accuracy = 0,
        .pp = B_UPDATED_MOVE_DATA == GEN_CUSTOM ? 5 : 10,
        .target = MOVE_TARGET_USER,
        .priority = 0,
        .category = DAMAGE_CATEGORY_STATUS,
        .healingMove = TRUE,
    ...
    [MOVE_FEINT] =
    {
        ...
        .type = B_UPDATED_MOVE_TYPES == GEN_CUSTOM ? TYPE_FIGHTING : TYPE_NORMAL,
        .accuracy = 100,
        .pp = 10,
        .target = MOVE_TARGET_SELECTED,
        .priority = 2,
    ...
    [MOVE_ACUPRESSURE] =
    {
        ...
        .type = TYPE_NORMAL,
        .accuracy = 0,
        .pp = B_UPDATED_MOVE_DATA == GEN_CUSTOM ? 15 : 30,
    ...
    [MOVE_SUCKER_PUNCH] =
    {
        ...
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .makesContact = TRUE,
        .punchingMove = B_UPDATED_MOVE_DATA == GEN_CUSTOM,
        .contestEffect = CONTEST_EFFECT_BETTER_IF_FIRST,
        .contestCategory = CONTEST_CATEGORY_SMART,
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
    ...
    [MOVE_DRAGON_RUSH] =
    {
        ...
        .power = 100,
        .type = TYPE_DRAGON,
        .accuracy = B_UPDATED_MOVE_DATA == GEN_CUSTOM ? 80 : 75,
        .pp = 10,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
    ...
    [MOVE_FOCUS_BLAST] =
    {
        ...
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_SP_DEF_MINUS_1,
            .chance = B_UPDATED_MOVE_DATA == GEN_CUSTOM ? 15 : 10,
        }),
        .contestEffect = CONTEST_EFFECT_STARTLE_MON_WITH_JUDGES_ATTENTION,
        .contestCategory = CONTEST_CATEGORY_COOL,
        .contestComboStarterId = 0,
    ...
    [MOVE_MUD_BOMB] =
    {
        ...
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_ACC_MINUS_1,
            .chance = B_UPDATED_MOVE_DATA == GEN_CUSTOM ? 50 : 30,
        }),
        .contestEffect = CONTEST_EFFECT_STARTLE_MON_WITH_JUDGES_ATTENTION,
        .contestCategory = CONTEST_CATEGORY_SMART,
        .contestComboStarterId = 0,
    ...
    [MOVE_AQUA_JET] =
    {
        ...
        .type = TYPE_WATER,
        .accuracy = 100,
        .pp = B_UPDATED_MOVE_DATA == GEN_CUSTOM ? 30 : 20,
        .target = MOVE_TARGET_SELECTED,
        .priority = 1,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .makesContact = TRUE,
    ...
    [MOVE_HEAD_SMASH] =
    {
        ...
        .power = 150,
        .type = TYPE_ROCK,
        .accuracy = B_UPDATED_MOVE_DATA == GEN_CUSTOM ? 85 : 80,
        .pp = 5,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
    ...
    [MOVE_SHADOW_FORCE] =
    {
        ...
        .effect = EFFECT_SEMI_INVULNERABLE,
        .power = B_UPDATED_MOVE_DATA == GEN_CUSTOM ? 140 : 120,
        .type = TYPE_GHOST,
        .accuracy = 100,
        .pp = 5,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_SCALD] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA == GEN_CUSTOM ? 70 : 80,
        .type = TYPE_WATER,
        .accuracy = 100,
        .pp = 15,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_QUASH] =
    {
        ...
        .pp = 15,
        .target = MOVE_TARGET_SELECTED,
        .priority = B_UPDATED_MOVE_DATA == GEN_CUSTOM ? 1 : 0,
        .category = DAMAGE_CATEGORY_STATUS,
        .zMove = { .effect = Z_EFFECT_SPD_UP_1 },
        .metronomeBanned = TRUE,
        .contestEffect = CONTEST_EFFECT_NEXT_APPEAL_LATER,
    ...
    [MOVE_HEART_STAMP] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = 60,
        .type = B_UPDATED_MOVE_TYPES == GEN_CUSTOM ? TYPE_FAIRY : TYPE_PSYCHIC,
        .accuracy = 100,
        .pp = 25,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
    ...
    [MOVE_LEAF_TORNADO] =
    {
        ...
        .priority = 0,
        .category = DAMAGE_CATEGORY_SPECIAL,
        .windMove = B_UPDATED_MOVE_DATA == GEN_CUSTOM,
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_ACC_MINUS_1,
            .chance = 50,
        }),
