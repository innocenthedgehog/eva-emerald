...
#define I_SELL_VALUE_FRACTION           GEN_8  // In Gen9+, items sell for 1/4 of their value instead of 1/2.
...
#define I_FISHING_CHAIN            TRUE      // Introduced in XY, hooking the same Pokémon repeatedly will increase the odds of that mon being shiny. NOTE: This implementation is an approximation of the actual feature, as XY have not been thoroughly documented or datamined.
#define I_FISHING_PROXIMITY        TRUE      // Introduced in XY, fishing away from other people in enclosed areas will increase the chances of a Pokémon being hooked. NOTE: This implementation is an approximation of the actual feature, as XY have not been thoroughly documented or datamined.
