...
#define P_UPDATED_TYPES             GEN_CUSTOM  // Some Pokémon have received type updates after their introduction.
#define P_UPDATED_STATS             GEN_CUSTOM  // Some Pokémon have received base stat updates after their introduction.
